    ...
    return (
        <div className="p-3 sm:p-6 w-full bg-gradient-to-b from-background/50 to-background/80 backdrop-blur-sm">
            <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
                ...
                <div className={`relative rounded-2xl sm:rounded-3xl transition-all duration-300 border-2 overflow-hidden ${isFocused
                        ? chatMode === 'general'
                    ...
                    <textarea
                        ...
                        rows={1}
                        className={`w-full resize-none px-4 sm:px-5 py-3 sm:py-4 pr-16 sm:pr-24 text-sm sm:text-base focus:outline-none disabled:opacity-50 min-h-[48px] sm:min-h-[56px] max-h-[200px] transition-all ${
                            chatMode === 'general'
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                        ...
                        {chatMode === 'roblox' && (
                            <div className="flex items-center gap-2">
                                {/* Script mode selector - moved first */}
